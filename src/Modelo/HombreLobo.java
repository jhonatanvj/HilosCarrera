 ...
 * @author jhona
 */
public class HombreLobo extends SuperHumano implements Runnable{
    
    Thread t;
    private int posicion;

    public HombreLobo(String nombre, JLabel personaje, JLabel labefinal) {
